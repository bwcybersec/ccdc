...
echo "Wait 2 minutes for mysql starts up..."
sleep 120
echo "Database should be now operational"
echo
echo "To login, use the command: "
echo "   mysql -h 0.0.0.0 -P 4406 -u root -p"
echo
echo
echo "Now we will create a sample database (MyDB) and populate it with some tables"
echo "When prompted, use the password: changeme"
