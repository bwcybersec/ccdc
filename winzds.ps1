...
Function Continue_ {
    # Please please please, I am begging you. Do not use this function during competitions. its just pauses the script.
...
Function Set_Internal_IPs {
    ...
    $global:Splunk = "172.20.242.20"
    $global:EComm = "172.20.242.104"
    $global:WebMail = "172.20.242.101"
    ...
    Write-host "-----------------------------"
    Write-Host "Windows 11 Work: $Win11wrkr"
...
Function Set_External_IPs {
    #This isnt update for the Spring 2026 network, as there is not an external box."
    cls
...
Function WinWeb{
   ...
   netsh advfirewall firewall add rule name="CCDC-Webserver"  new dir=in action=allow enable=yes protocol=udp profile=any localport=80,443  | Out-Null
...
Function WinFTP{
   ...
   netsh advfirewall firewall add rule name="CCDC-FTPserver"  new dir=in action=allow enable=yes protocol=udp profile=any localport=20,21  | Out-Null
}
